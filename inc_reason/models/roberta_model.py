# Code based from https://github.com/alontalmor/LeapOfThought/blob/master/LeapOfThought/allennlp_models/models/transformer_binary_qa_model.py
from typing import Dict, Optional, List, Any
import logging

from transformers import RobertaModel, BertModel, XLNetModel
